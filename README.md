...
* **Živý web (GitHub Pages):** [https://errorsfixer.com](https://errorsfixer.com) (web je hostován přes GitHub Pages a propojen s vlastní doménou pomocí souboru `CNAME.txt` od hostingu Namecheap).
