...
* **Živý web (GitHub Pages):** (https://matyasrada24.github.io/Web_Prace/) (web je hostován přes GitHub Pages a propojen s vlastní doménou pomocí souboru `CNAME.txt` od hostingu Namecheap).
