...
* **Živý web (GitHub Pages):** [https://errorsfixer.com](https://[errorsfixer.com](https://matyasrada24.github.io/Web_Prace/)) (web je hostován přes GitHub Pages a propojen s vlastní doménou pomocí souboru `CNAME.txt` od hostingu Namecheap).
...
![ErrorFixer Homepage](og-image.png)
